                        ...
                        <form method="POST" action="{{ route('usuarios.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-select @error('Genero') is-invalid @enderror"
                                            aria-label="Seleccione su genero" id="Genero" name="Genero">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-select @error('Ciudad') is-invalid @enderror"
                                            aria-label="Seleccione su Ciudad" id="Ciudad" name="Ciudad">
